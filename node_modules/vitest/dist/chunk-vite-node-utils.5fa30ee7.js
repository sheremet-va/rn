...
${getStack()}`), 2e3);
    ...
    if(this.shouldResolveId(id) && !id.startsWith('/@vite')) {
      id = (await this.options.resolveId(id, _callstack.at(-1)))?.id;
    }
